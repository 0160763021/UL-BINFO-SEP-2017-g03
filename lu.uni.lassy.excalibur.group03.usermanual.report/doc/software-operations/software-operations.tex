...
\item \textbf{Parameters:} UserName
...
\item \textbf{Parameters:} FirstName,LastName, Username, E-mail,
Password,ConfirmPassword, Birth date, Phone number, right1,right2,right3,right4,right5,right6,right7,right8
\item \textbf{Precondition:} The person must be the super-SysAdmin and be logged
in with the super-SysAdmin's account.
...
\begin{figure}[H]
\centering
\includegraphics[width=170mm]{images/CreateSysTrigger1.eps}
\caption{\label{overflow}}
\end{figure}
...
\item \textbf{Parameters:} inputPassword, UserName
...
\begin{figure}[H]
\centering
\includegraphics[width=170mm]{images/CinfrimPasswordTrigger.eps}
\caption{\label{overflow}}
\end{figure}
...
\item \textbf{Parameters:} newEmail, UserName
\item \textbf{Precondition:} The person must be the super-SysAdmin or the
...
\begin{figure}[H]
\centering
\includegraphics[width=170mm]{images/EmailTrigger.eps}
\caption{\label{overflow}}
\end{figure}
...
\item \textbf{Parameters:} newId, UserName
\item \textbf{Precondition:} The person must be the super-SysAdmin or the
...
\begin{figure}[H]
\centering
\includegraphics[width=170mm]{images/IdTrigger.eps}
\caption{\label{overflow}}
\end{figure}
...
\item \textbf{Parameters:} newPassword, UserName
\item \textbf{Precondition:} The person must be the super-SysAdmin or the
...
\begin{figure}[H]
\centering
\includegraphics[width=170mm]{images/PasswordTrigger.eps}
\caption{\label{overflow}}
\end{figure}
