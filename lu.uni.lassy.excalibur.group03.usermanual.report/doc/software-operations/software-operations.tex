...
\item \textbf{Precondition:} Inorder to create a virtual machine the sysAdmin
has to be logged in.
\item \textbf{Post-condition:} The sysAdmin will be allowed to proceed to the
next screen under the condition that he has specified a name and a description
for the virtual machine which allows him to choose the components of the virtual
machine that he wants to create. In case an information is missing an error
...
specified id exists. The sysAdmin must be logged in.
\item \textbf{Post-condition:} A notification will be sent to the sysAdmin
informing about the creation of the virtual machine.
...
\item \textbf{Triggering:}
\begin{enumerate}
\item Click on the green arrow to accept the creation of the virtual machine.
\end{enumerate}
