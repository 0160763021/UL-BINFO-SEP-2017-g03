...
\item [\textbf{Primary Actor}:] Administrator Bob
\item [\textbf{Goal:}] The administrator Bob should be able to get an overview
of the datacenter
...
6. \emph{Bob} after he's done overview the choosen component \emph{Bob} can go
back to the administrators home screen by clicking on the \emph{Back} button.\\


\item [\textbf{Extensions}]:\\
2.a \emph{Bob} has to be an administrator and has to be logged in in order to
...
\begin{lyxlist}{PC1}
\small{
\item [\textbf{Procedure:}] RegularUserCreation 
\item [\textbf{Scope:}] Allow the administrator to create a new regular user
\item [\textbf{Primary Actor}:] Administrator Bob
\item [\textbf{Goal:}] The administrator Bob should be able to create a new
regular user.
\item [\textbf{Level}:] Administrator level
\item [\textbf{Main~Success~Scenario}]:\\
1. \emph{Bob} has to click on the "CREATE NEW USER '' button in the admin home
screen.\\
...
4. \emph{Bob} has to attribute the different rights for the Regular user.
...
regular user.
\\
6. \emph A new regular user has been created and {Bob} only need to click
on the " ok" button.\\
