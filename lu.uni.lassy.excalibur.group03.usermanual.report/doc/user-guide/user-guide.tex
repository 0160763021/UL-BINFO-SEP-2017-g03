...
SETTINGS'.
Fig 3.3\\
4. \emph{John} must enter a name for the virtual machine such as 'JOHNsVM'
and a description 'VM for software engeneering project' (optional). Fig 3.4\\
5. \emph{John} must select a CPU 'Intel Xeon E3-1630'. Fig 3.5\\
...
back.\\
7. \emph{John} must select how much does he wants '32GB ECC memory'. Fig
3.5\\
8. \emph{John} must click on the right arrow which allows him to
proceed to the next component.
9. \emph{John} must select a GPU 'NVIDIA QUADRO P4000'. Fig 3.5\\
10. \emph{John} must click on the right arrow which allows him to
proceed to the next component.
11. \emph{John} must select a HDD '4TB 7200 RPM'. Fig 3.5\\
12. \emph{John} must click on the right arrow which allows him to
proceed to the next component.
13. \emph{John} must select a SSD '1 TB SATA SSD'. Fig 3.5\\
14. \emph{John} must click on the right arrow which allows him to
proceed to the next component.
15. \emph{John} must select a SOFTWARE 'autoCAD'. Fig 3.5\\
16. \emph{John} must click on the right arrow which allows him to
proceed to the next component.
17. \emph{John} will be at the finish page, here John has now the option to
...
4. \emph{John} must enter a name for his virtual machine 'JOHN'sTEMPLATEVM' and
a description 'VM for software engeneering project' (optional).\\
5. \emph{John} must click on the button named 'NEXT'.\\
